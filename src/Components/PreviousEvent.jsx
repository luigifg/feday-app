...
const Previous = () => {
  ...
  const prevSlide = () => {
    setCurrentIndex((prevIndex) => 
      Math.max(0, prevIndex - imagesPerView)
    );
  };
            ...
            <div className="flex items-center justify-center w-full space-x-4 px-10">
              ...
              {!isMobile && (
                <button
                  ...
                  className={`flex-shrink-0 bg-white p-2 rounded-full shadow-md transition-opacity duration-300 
                    ${isPrevDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'}`}
              ...
              {!isMobile && (
                <button
                  ...
                  className={`flex-shrink-0 bg-white p-2 rounded-full shadow-md transition-opacity duration-300 
                    ${isNextDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'}`}
